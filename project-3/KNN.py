...
def k_neighbors(x, y):
    ...
    plt.savefig(path_k_nearest_neighbor_plots + "error_metrics/knn_r2.png", bbox_inches='tight')
    plt.clf()
    ...
    plt.savefig(path_k_nearest_neighbor_plots + "error_metrics/knn_rmse.png", bbox_inches='tight')
    plt.clf()
    ...
    plt.savefig(path_k_nearest_neighbor_plots + "error_metrics/knn_mae.png", bbox_inches='tight')
    plt.clf()
    # plt.show()
